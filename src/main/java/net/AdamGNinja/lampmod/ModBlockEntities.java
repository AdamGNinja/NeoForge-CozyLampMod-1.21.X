...
public class ModBlockEntities {
    ...
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, LampMod.MOD_ID);

    public static final RegistryObject<BlockEntityType<DeskLampBlockEntity>> DESK_LAMP_BE =
